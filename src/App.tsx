                ...
                <tbody className="text-sm">
                  {(dashboardView === 'pending' ? enrichedRecommendations : approvedItems)?.map((rec) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-6">
                        <span className={`text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-lg border ${
                          rec.applied_config?.engine_mode === 'ai'
                            ? 'text-blue-500 bg-blue-500/10 border-blue-500/20'
                            : 'text-emerald-500 bg-emerald-500/10 border-emerald-500/20'
                        }`}>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      ...
                      className={`px-6 py-3 rounded-2xl border font-black text-xs uppercase tracking-widest transition-all ${
                        (localConfig.engine_mode || 'rule') === 'rule'
            ...
            <div className="relative border-l-2 border-[var(--border)] ml-4 pl-10 space-y-12 py-4">
              {activityLog.length === 0 ? (
                ...
                activityLog.map((log) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className={`absolute -left-[51px] w-5 h-5 rounded-full border-4 border-[var(--bg)] ${
                      log.type === 'approval' ? 'bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.5)]' :
                    ...
                    <div className="bg-[var(--bg-secondary)] border border-[var(--border)] p-6 rounded-3xl hover:border-blue-500/30 transition-colors shadow-sm">
                      ...
                      <div className="mt-4 flex items-center gap-2">
                        <span className={`text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded ${
                           log.type === 'approval' ? 'bg-emerald-500/10 text-emerald-500' :
